  ...
  ...railwayLine(
    ...
    [
      ...
      },
      {
        ...
        visibility: ['in', ['global-state', 'tracks'], ['literal', ['track', 'passenger_lines']]],
      },
      {
...

      {
        ...
        visibility: ['in', ['global-state', 'tracks'], ['literal', ['usage', 'speed', 'track', 'operator', 'routes', 'passenger_lines']]],
      },
      {
