...
const electrificationPowerColor = (voltageProperty, maximumCurrentProperty) => ['case',
  ...
  ], turboColorMap(['*', ['get', voltageProperty], ['get', maximumCurrentProperty]], 0, 40_000_000, 0.5),
  ['any',
    ['==', ['get', 'electrification_state'], 'deelectrified'],
    ['==', ['get', 'electrification_state'], 'abandoned'],
  ], color_delectrified,
    ...
    ...railwayLine(
      ['match', ['global-state', 'electrificationRailwayLine'],
        ...
        'power', ['case',
          ...
          ], ['concat', ['number-format', ['*', ['get', 'voltage'], ['get', 'maximum_current'], 0.001], {'max-fraction-digits': 0}], ' kW'],
          '',
        ],
