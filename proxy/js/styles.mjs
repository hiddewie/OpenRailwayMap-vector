...
const layers = Object.fromEntries(knownThemes.map(theme => [theme, {
  ...
  signals: [
    ...
    // { // ['get', 'feature_main'],
      {
        ...
        paint: {
          ...
          'text-halo-width': ['case',
            ['==', ['slice', ['get', 'feature_main'], 0, 20], 'de/blockkennzeichen-'], 2.0,
            1.5,
          ],
          'text-halo-blur': 1,
        },
        layout: {
          ...
          'text-field':
            // ['case',
            // ['==', ['slice', ['get', 'feature_main'], 0, 20], 'de/blockkennzeichen-'], ['get', 'ref_multiline'],
            ['format',
              ['case', ['!=', ['get', 'feature_main'], null], ['image', ['get', 'feature_main']], ''],
              {},
              ['case', ['!=', ['get', 'feature_main'], null], '\n', ''],
              {},
              ['case', ['!=', ['get', 'feature_distant'], null], ['image', ['get', 'feature_distant']], ''],
              {},
              ['case', ['!=', ['get', 'feature_distant'], null], '\n', ''],
              {},
              ['get', 'ref'],
              {},
            // ],
          ...
          'text-anchor': 'center',
          // 'text-offset': ['case',
          //   ['==', ['slice', ['get', 'feature_main'], 0, 20], 'de/blockkennzeichen-'], ['literal', [0, 0]],
          //   ['literal', [0, 1.5]],
          // ],
        },
      },
    ...
    //       ],
    //       'text-halo-width': ['case',
    //         ['==', ['slice', ['get', 'feature_distant'], 0, 20], 'de/blockkennzeichen-'], 2.0,
    //         1.5,
    //       ],
    //       'text-halo-blur': 1,
    //     },
    ...
    //       'symbol-z-order': 'source',
    //       'icon-overlap': 'always',
    //       // 'icon-offset': ['literal', [0, 1.5]],
    //       'text-field': ['case',
    //         ['==', ['slice', ['get', 'feature_distant'], 0, 20], 'de/blockkennzeichen-'], ['get', 'ref_multiline'],
    //         ['get', 'ref'],
    //       ],
    //       'text-font': ['Noto Sans Medium'],
    //       'text-size': 9,
    //       'text-optional': true,
    //       'text-anchor': ['case',
    //         ['==', ['slice', ['get', 'feature_distant'], 0, 20], 'de/blockkennzeichen-'], 'center',
    //         'top',
    //       ],
    //       'text-offset': ['case',
    //         ['==', ['slice', ['get', 'feature_distant'], 0, 20], 'de/blockkennzeichen-'], ['literal', [0, 0]],
    //         ['literal', [0, 1.5]],
    //       ],
    //     },
    //   },
