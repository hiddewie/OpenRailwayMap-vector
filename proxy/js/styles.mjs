  ...
  },
  {
    ...
    paint: {
      'fill-color': ['match', ['global-state', 'stations'],
        'station', ['case',
          ['in', ['get', 'state'], ['literal', ['disused', 'abandoned', 'razed', 'preserved']]], colors.styles.standard.past,
  ...
  ...historicalRailwayLine(
    ...
    [
      ...
      },
      {
        ...
        color: ['match', ['global-state', 'tracks'],
          'usage', colors.styles.standard.main,
          'gray',
        ],
        dash: ['match', ['get', 'type'],
          'construction', ['literal', construction_dasharray],
      ...
      },
      {
        ...
        color: ['match', ['global-state', 'tracks'],
          'usage', colors.styles.standard.narrowGauge,
          'gray',
        ],
        width: 2,
      },
      ...
      },
      {
        ...
        width: 2,
        color: ['match', ['global-state', 'tracks'],
          'usage', colors.styles.standard.tourism,
          'gray',
        ],
      },
      {
        ...
        color: ['match', ['global-state', 'tracks'],
          'usage', colors.styles.standard.industrial,
          'gray',
        ],
      },
      {
        ...
        color: ['match', ['global-state', 'tracks'],
          'usage', colors.styles.standard.branch,
          'gray',
        ],
      },
      {
  ...
  ...railwayLine(
    ['step', ['zoom'],
      ['match', ['global-state', 'tracks'],
        ...
        'train_protection', '',
        'voltage_frequency', trackLabel.voltageFrequency,
        'maximum_current', trackLabel.maximumCurrent,
        'power', trackLabel.power,
        'gauge', trackLabel.gauge,
        'loading_gauge', trackLabel.loadingGauge,
        'track_class', trackLabel.trackClass,
    ...
    [
      ...
      },
      {
        ...
        color: ['match', ['global-state', 'tracks'],
          'voltage_frequency', electrificationVoltageFrequencyColor('voltage', 'frequency'),
          'maximum_current', electrificationVoltageMaximumCurrentColor('maximum_current'),
          'power', electrificationPowerColor('voltage', 'maximum_current', 'frequency'),
          colors.styles.standard.unknown,
        ],
        visibility: ['in', ['global-state', 'tracks'], ['literal', ['voltage_frequency', 'maximum_current', 'power']]],
      },
      {
        id: 'track_line_low',
        minzoom: 0,
        ...
        color: ['match', ['global-state', 'tracks'],
          'gauge', gaugeColor('gauge0', 'gaugeint0'),
          'loading_gauge', loadingGaugeFillColor,
          'track_class', trackClassFillColor,
        ...
        visibility: ['in', ['global-state', 'tracks'], ['literal', ['gauge', 'loading_gauge', 'track_class', 'passenger_lines']]],
      },
      {
      ...
      },
      {
        ...
        color: ['match', ['coalesce', ['get', 'route_count'], 0],
          0, 'gray',
...

      {
        ...
        width: 2,
        filter: ['case',
          ['in', ['global-state', 'tracks'], ['literal', ['speed', 'gauge', 'loading_gauge', 'track_class',
          'operator', 'routes', 'passenger_lines']]], ['!=', ['get', 'feature'], 'ferry'],
          true,
        ],
        color: ['match', ['global-state', 'tracks'],
...

      {
        ...
        filter: ['case',
          ['in', ['global-state', 'tracks'], ['literal', ['speed', 'loading_gauge', 'track_class']]], ['!=', ['get', 'feature'], 'ferry'],
          true,
        ],
        width: ["interpolate", ["exponential", 1.2], ["zoom"],
          8, ['match', ['get', 'state'],
          ...
          'usage', ['match', ['get', 'state'],
            ...
            ['match', ['get', 'feature'],
              'rail', ['match', ['get', 'usage'],
                ...
                'test', colors.styles.standard.test,
                'military', colors.styles.standard.military,
                'tourism', colors.styles.standard.tourism,
                ['match', ['get', 'service'],
                  'spur', colors.styles.standard.spur,
                  'siding', colors.styles.standard.siding,
                  'yard', colors.styles.standard.yard,
      ...
      },
      {
        ...
        color: ['match', ['global-state', 'tracks'],
          'voltage_frequency', electrificationVoltageFrequencyColor('future_voltage', 'future_frequency'),
          'maximum_current', electrificationVoltageMaximumCurrentColor('future_maximum_current'),
      ...
      },
      {
        ...
        visibility: ['==', ['global-state', 'tracks'], 'gauge'],
      },
      {
...

  {
    ...
    layout: {
      ...
      'icon-image': ['image', ['concat', 'sdf:general/station-', ['case',
        ['in', ['get', 'state'], ['literal', ['disused', 'abandoned', 'razed', 'preserved']]], 'past',
