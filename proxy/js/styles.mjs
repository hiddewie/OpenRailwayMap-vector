    ...
    ...[0, 1, 2, 3, 4, 5].flatMap(featureIndex =>
      imageLayerWithOutline(
        ...
        ['case',
          ['all',
            ['==', `${featureIndex}`, '0'],
            ['==', ['slice', ['get', `feature0`], 0, 20], 'de/bue-crossing-info'],
          ], 
          'de/bue-crossing-info-large',
          ['get', `feature${featureIndex}`],
        ],
        {
          type: 'symbol',
          ...
          layout: {
            ...
            'icon-overlap': 'always',
            'icon-offset': ['case',
              ['==', ['slice', ['get', `feature${featureIndex}`], 0, 20], 'de/blockkennzeichen-'], ['literal', [0, -40 * featureIndex]],
              ['==', ['slice', ['get', `feature${featureIndex}`], 0, 20], 'de/bue-crossing-info'], ['literal', [0, -25 * featureIndex]],
    ...
    ),
    {
      ...
      layout: {
        ...
        'text-field': ['format',
          ...
          ['case',
            ['all', ['!=', ['get', 'ref'], null],['!=', ['get', 'caption'], null]], '\n',
            '',
          ], {},
          ['case',
            ['==', ['get', 'feature0'], 'de/bue-crossing-info'], ['get', 'caption_multiline'],
            ['==', ['get', 'caption'], null], '',
            ['get', 'caption']
        ...
        'text-anchor': ['case',
          ...
          ['==', ['slice', ['get', 'feature0'], 0, 20], 'de/bue-crossing-info'], 'center',
          'top',
        ],
        'text-offset': ['case',
          ['==', ['slice', ['get', 'feature0'], 0, 20], 'de/blockkennzeichen-'], ['literal', [0, 0]],
          ['==', ['slice', ['get', 'feature0'], 0, 20], 'de/bue-crossing-info'], ['literal', [0, 0]],
          ['literal', [0, 1.5]],
        ],
      },
    },
