...
const colors = {
  ...
  styles: {
    standard: {
      ...
      stationsText: themeSwitch('blue', '#00298d'),
      yardText: themeSwitch('#87491D', '#bdcfff'),
      tramStopText: themeSwitch('#D877B8', '#ffa35f'),
      lightRailText: themeSwitch('#0e5414', '#f8c7e8'),
      monorailText: themeSwitch('#00674d', '#83ea8f'),
      miniatureText: themeSwitch('#503285', '#5fffd7'),
      funicularText: themeSwitch('#d75656', '#503285'),
      defaultText: themeSwitch('#616161', '#daa3a3'),
      past: themeSwitch('#535353', '#d2d2d2'),
      future: themeSwitch('#fff732', '#dadada'),
      signalBox: {
        text: themeSwitch('#404040', '#fffdcc'),
        halo: themeSwitch('#bfffb3', '#bfffb3'),
      },
      track: {
        text: themeSwitch('white', '#404040'),
        halo: themeSwitch('blue', 'white'),
        hover: themeSwitch('yellow', '#00298d'),
      },
      switch: {
        default: themeSwitch('#003687', 'yellow'),
        localOperated: themeSwitch('#005129', '#a7c6fc'),
        resetting: themeSwitch('#414925', '#85f5bd'),
      },
      symbols: themeSwitch('black', '#bdc2ab'),
      platform: themeSwitch('#aaa', 'white'),
    },
  },
  km: {
