...
const signalPositionOffsets = [
  {
    position: 'left',
    filter: ['==', ['get', 'signal_position'], 'left'],
    offset: [-20, 0],
  },
  {
    position: 'right',
    filter: ['==', ['get', 'signal_position'], 'right'],
    offset: [20, 0],
  },
  {
    position: 'other',
    filter: ['all',
      ['==', ['get', 'signal_position'], 'right'],
      ['==', ['get', 'signal_position'], 'left'],
    ],
    offset: null,
  },
];
...
const layers = Object.fromEntries(knownThemes.map(theme => [theme, {
  ...
  speed: [
    ...
    ...signalPositionOffsets.flatMap(({position, filter, offset}) => [
      {
        id: `speed_railway_signal_direction_${position}`,
        type: 'symbol',
        minzoom: 13,
      ...
      ...[0, 1].flatMap(featureIndex =>
        imageLayerWithOutline(
          theme,
          `speed_railway_signals_${position}_${featureIndex}`,
      ...
      {
        id: `speed_railway_signals_deactivated_${position}`,
        type: 'symbol',
        minzoom: 13,
        source: 'openrailwaymap_speed',
        'source-layer': 'speed_railway_signals',
      ...
      {
        id: `speed_railway_signals_text_${position}`,
        type: 'symbol',
        minzoom: 16,
        source: 'openrailwaymap_speed',
        'source-layer': 'speed_railway_signals',
