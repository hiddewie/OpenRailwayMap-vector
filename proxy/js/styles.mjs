...
const railwayLine = (text, layers) => [
  ...
  ...layers.map(({id, minzoom, maxzoom, source, sourceLayer, visibility, filter, width, gapWidth, states, sort}) => ({
    id: `${id}_tunnel_cover`,
    type: 'line',
  ...
  ...layers
    .filter(({gapWidth}) => !gapWidth)
    .filter(({states}) => states.includes('present'))
  ...
  standard: [
    ...
    ...railwayLine(
      ...
      [
        ...
        {
          id: 'railway_line_main_med_construction_proposed',
          minzoom: 7,
          maxzoom: 8,
          source: 'openrailwaymap_low',
          states: ['construction', 'proposed'],
          dash: {
            construction: construction_dasharray,
            proposed: proposed_dasharray,
          },
        ...
        {
          id: 'railway_line_branch_med_construction_proposed',
          minzoom: 7,
          maxzoom: 8,
          source: 'openrailwaymap_low',
          states: ['construction', 'proposed'],
