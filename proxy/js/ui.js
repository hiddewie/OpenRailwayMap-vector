...
function popupContent(properties) {
  ...
  return `
    ...
    <h6>
      ${properties.reporting_marks ? `<span class="badge badge-pill badge-light">reporting marks: <span class="text-monospace">${properties.reporting_marks.replace(/^{|}$/g, '')}</span></span>` : ''}
