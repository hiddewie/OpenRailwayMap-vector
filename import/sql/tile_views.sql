...
CREATE OR REPLACE VIEW signals_railway_signals AS
  SELECT
    ...
    replace("railway:signal:combined:states", ';', U&'\001E') as "railway:signal:combined:states",
    ...
    replace("railway:signal:crossing_distant:states", ';', U&'\001E') as "railway:signal:crossing_distant:states",
    ...
    replace("railway:signal:departure:states", ';', U&'\001E') as "railway:signal:departure:states",
    "railway:signal:distant",
    "railway:signal:distant:form",
    "railway:signal:distant:repeated",
    "railway:signal:distant:shortened",
    replace("railway:signal:distant:states", ';', U&'\001E') as "railway:signal:distant:states",
    ...
    replace("railway:signal:main:states", ';', U&'\001E') as "railway:signal:main:states",
    ...
    replace("railway:signal:main_repeated:states", ';', U&'\001E') as "railway:signal:main_repeated:states",
    "railway:signal:main_repeated:substitute_signal",
    "railway:signal:minor",
    "railway:signal:minor:form",
    replace("railway:signal:minor:states", ';', U&'\001E') as "railway:signal:minor:states",
    "railway:signal:minor:height",
    "railway:signal:minor_distant",
    "railway:signal:minor_distant:form",
    replace("railway:signal:minor_distant:states", ';', U&'\001E') as "railway:signal:minor_distant:states",
    ...
    replace("railway:signal:route:states", ';', U&'\001E') as "railway:signal:route:states",
    "railway:signal:route_distant",
    "railway:signal:route_distant:form",
    replace("railway:signal:route_distant:states", ';', U&'\001E') as "railway:signal:route_distant:states",
    "railway:signal:short_route",
    "railway:signal:short_route:form",
    "railway:signal:shunting",
    "railway:signal:shunting:form",
    replace("railway:signal:shunting:states", ';', U&'\001E') as "railway:signal:shunting:states",
    ...
    replace("railway:signal:speed_limit:states", ';', U&'\001E') as "railway:signal:speed_limit:states",
