...
CREATE OR REPLACE VIEW speed_railway_signals AS
  SELECT
    ...
    array_to_string("railway:signal:combined:states", U&'\001E') as "railway:signal:combined:states",
    ...
    array_to_string("railway:signal:crossing_distant:states", U&'\001E') as "railway:signal:crossing_distant:states",
    ...
    array_to_string("railway:signal:departure:states", U&'\001E') as "railway:signal:departure:states",
    "railway:signal:distant",
    "railway:signal:distant:form",
    "railway:signal:distant:repeated",
    "railway:signal:distant:shortened",
    array_to_string("railway:signal:distant:states", U&'\001E') as "railway:signal:distant:states",
    ...
    array_to_string("railway:signal:main:states", U&'\001E') as "railway:signal:main:states",
    ...
    array_to_string("railway:signal:main_repeated:states", U&'\001E') as "railway:signal:main_repeated:states",
    "railway:signal:main_repeated:substitute_signal",
    "railway:signal:minor",
    "railway:signal:minor:form",
    array_to_string("railway:signal:minor:states", U&'\001E') as "railway:signal:minor:states",
    "railway:signal:minor:height",
    "railway:signal:minor_distant",
    "railway:signal:minor_distant:form",
    array_to_string("railway:signal:minor_distant:states", U&'\001E') as "railway:signal:minor_distant:states",
    ...
    array_to_string("railway:signal:route:states", U&'\001E') as "railway:signal:route:states",
    "railway:signal:route_distant",
    "railway:signal:route_distant:form",
    array_to_string("railway:signal:route_distant:states", U&'\001E') as "railway:signal:route_distant:states",
    "railway:signal:short_route",
    "railway:signal:short_route:form",
    "railway:signal:shunting",
    "railway:signal:shunting:form",
    array_to_string("railway:signal:shunting:states", U&'\001E') as "railway:signal:shunting:states",
    ...
    array_to_string("railway:signal:speed_limit:speed", U&'\001E') as "railway:signal:speed_limit:speed",
    array_to_string("railway:signal:speed_limit:states", U&'\001E') as "railway:signal:speed_limit:states",
    "railway:signal:speed_limit_distant",
    "railway:signal:speed_limit_distant:form",
    array_to_string("railway:signal:speed_limit_distant:speed", U&'\001E') as "railway:signal:speed_limit_distant:speed",
