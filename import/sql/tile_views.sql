  ...
  SELECT
    ...
    CASE
      ...
      WHEN railway = 'level_crossing' THEN
        CASE
          WHEN crossing_barrier AND crossing_light AND crossing_bells THEN 'general/level-crossing-barrier'
          WHEN crossing_light AND crossing_bells THEN 'general/level-crossing-light'
