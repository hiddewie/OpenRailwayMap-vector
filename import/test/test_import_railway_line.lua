...
assert.eq(osm2pgsql.get_and_clear_imported_data(), {
  railway_line = {
    { id = '123-0', tunnel = false, bridge = false, highspeed = false, preserved = false, rank = 40, way_length = 1, way = way, feature = 'rail', state = 'present', train_protection = '{"aws","tpws"}', train_protection_rank = 34, train_protection_construction = 'etcs_2', train_protection_construction_rank = 71 },
  },
})
...
assert.eq(osm2pgsql.get_and_clear_imported_data(), {
  railway_line = {
    { id = '123-0', tunnel = false, bridge = false, highspeed = false, preserved = false, rank = 40, way_length = 1, way = way, feature = 'rail', state = 'present', train_protection = '{"ktcs"}', train_protection_rank = 76 },
  },
})
...
assert.eq(osm2pgsql.get_and_clear_imported_data(), {
  railway_line = {
    { id = '123-0', tunnel = false, bridge = false, highspeed = false, preserved = false, rank = 40, way_length = 1, way = way, feature = 'rail', state = 'present', train_protection = '{"acses","atc"}', train_protection_rank = 70 },
  },
})
